/**
 * HyperAgent_Config.js — 环境变量安全配置
 *
 * 优先级: HyperAgent_Ultimate_Config.js > process.env > 默认值
 */

let ultimateConfig = null;
try {
    ultimateConfig = require('./HyperAgent_Ultimate_Config.js');
...
if (ultimateConfig) {
    ...
    mcpServers: {
        ...
        shell: {
            command: 'node',
            args: [
                require('path').join(__dirname, 'HyperAgent_Core', 'mcp_client', 'mcp_server_shell.js')
            ]
        },
