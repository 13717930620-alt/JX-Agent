...
const ExperienceDatabase = require('../../HyperAgent_Implementation/cognitive_core/ExperienceDatabase');
const CarrierProfile = require('../../HyperAgent_Implementation/cognitive_core/CarrierProfile');
...
const CarrierSelfDiscovery = require('../../HyperAgent_Implementation/cognitive_core/CarrierSelfDiscovery');
...
class CognitiveFramework {
    constructor(options = {}) {
        this.version = '1.3.0';
        this.name = 'HyperAgent Cognitive Framework';
        ...
        this.carrierProfile = new CarrierProfile({
            ...
            name: options.name || 'HyperAgent Carrier'
        });
