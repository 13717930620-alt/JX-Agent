...
[Windows.UI.Notifications.ToastNotificationManager]::CreateToastNotifier("HyperAgent").Show($toast)
`;
...
const PowerTools = {
    system_power: async (params) => {
        ...
        const commands = {
            shutdown: 'shutdown /s /t 10 /c "HyperAgent 触发的关机"',
            restart: 'shutdown /r /t 10 /c "HyperAgent 触发的重启"',
